  ...
  return (
    <section className="relative overflow-hidden min-h-[88vh] flex items-center justify-center px-4 pt-12 pb-20 md:py-32">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(52,211,153,0.10),transparent)]" />
        <div className="absolute top-1/3 -start-40 w-[500px] h-[500px] bg-purple-700/[0.08] rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 -end-40 w-[400px] h-[400px] bg-purple-600/[0.06] rounded-full blur-3xl" />
        <div className="absolute top-1/2 start-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[radial-gradient(ellipse,rgba(99,102,241,0.06),transparent_70%)] rounded-full" />
      </div>

      <div className="relative z-10 max-w-4xl mx-auto text-center w-full">
        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] font-bold leading-[1.12] mb-6 md:mb-7 tracking-tight bg-gradient-to-r from-purple-300 via-emerald-400 to-purple-400 bg-clip-text text-transparent">
          {tx.heroTitle}
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3.5 justify-center items-center mb-14 md:mb-20">
          <button
            ...
            className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-emerald-400 hover:from-emerald-400 hover:to-emerald-300 text-white font-semibold px-9 py-4 rounded-xl transition-all shadow-2xl shadow-emerald-500/25 hover:shadow-emerald-400/40 hover:scale-[1.03] active:scale-[0.97] text-base"
          >
            {tx.heroPrimaryCta}
          </button>
          <button
